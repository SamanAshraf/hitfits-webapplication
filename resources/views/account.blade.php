...
<body>
  ...
  <nav class="navbar navbar-light bg-light bg-white py-0"  id="nav">
        ...
        <li class="active">
            ...
            <ul class="collapse list-unstyled" id="menSubmenu">
                <li class="subcat" style="font-weight: bold;">
                  <a href="./ALLMEN.HTML">View All</a>
                </li>
                <li class="subcat">
                    <a href="./MENALLPRODUCTS.HTML">T Shirts</a>
                </li>
                <li class="subcat">
                    <a href="#">Trousers</a>
                </li>
          ...
          <li>
            ...
            <ul class="collapse list-unstyled" id="womenSubmenu">
                <li class="subcat" style="font-weight: bold;">
                  <a href="./ALLWOMEN.HTML">View All</a>
                </li>
                <li class="subcat">
                    <a href="./allproducts.html">T Shirts</a>
                </li>
                <li class="subcat">
                    <a href="#">Trousers</a>
                </li>
          ...
          <li>
            ...
            <ul class="collapse list-unstyled" id="juniorsSubmenu">
                <li class="subcat" style="font-weight: bold;">
                  <a href="./ALLKIDS.HTML">View All</a>
                </li>
                <li class="subcat">
                    <a href="./KIDSPRODUCT.HTML">T Shirts</a>
                </li>
                <li class="subcat">
                    <a href="#">Trousers</a>
                </li>
    ...
    <a href="/" class="nav-ti">HitFits</a>
        ...
        <ul class="navbar">
          ...
          @endif
          <li class="icons"><a href="{{url('checkout')}}"><i class="fa fa-shopping-bag" aria-hidden="true" style=""></i></a></li>
        </ul>
  ...
  <div class="container">
    ...
    <hr>
    <h6>NAME:</h6>
    <p>{{ $LoggedUserInfo['firstname']}} {{ $LoggedUserInfo['lastname']}}</p>
    <h6>EMAIL</h6>
    ...
    <button type="submit" class="btn btn-light btn-block">Track Your Order</button>
    <a href="{{route('logout')}}"><button type="submit" class="btn btn-light btn-block">Logout</button></a>
