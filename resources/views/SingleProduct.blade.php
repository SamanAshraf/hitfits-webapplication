  ...
  <div class="container">
    <div class="row">
        ...
        @csrf
            ...
            <img src="{{\Illuminate\Support\Facades\Storage::url($products['img'])}}" width="100%" id="MainImg">
            <div class="small-img-row">
              <div class="small-img-col">
                  <img src="{{\Illuminate\Support\Facades\Storage::url($products['img1'])}}" width="100%" class="small-img" onclick="change1()" >
              </div>
              <div class="small-img-col">
                  <img src="{{\Illuminate\Support\Facades\Storage::url($products['img2'])}}" width="100%" class="small-img" onclick="change2()" >
              </div>
              <div class="small-img-col">
                  <img src="{{\Illuminate\Support\Facades\Storage::url($products['img3'])}}"width="100%" class="small-img" onclick="change3()">
              </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <h6>F0090/206/607-10376968</h6>
            <h6>{{$products['description']}}</h6>
            <h6>The model is wearing size: S; Model height: 5.3ft /160cm</h6>
            <h4> PKR {{$products['salesprice']}}</h4>
            <p>Color: {{$products['color']}}</p>
            <i class="fa fa-circle" style="font-size:24px;color:plum"></i>
            <p>Select Size:</p>
            <div class="page-btn">
                <span>S</span>
                <span>M</span>
            ...
            <input type="number" id="q1" style="width:90px;" value="1" > <br> <br> -->
            <button type="submit" class="button-1">Size Chart</button> <br> <br>
            <a href="{{ route('add.to.cart', $products->id) }}"><button type="submit" class="btn btn-light btn-block" id="btn1">ADD TO CART</button></a>
            
            <!-- <button type="submit" class="btn btn-light btn-block" id="btn2">ADD TO WISHLIST</button> -->
            <h4>Composition and care</h4>
            <p>
                60% Cotton, 40% Polyester <br>
                Machine wash up to 30°C/86°F gentle cycle <br>
                Do not bleach <br>
                Iron up to 110°C/230°F <br>
                Do not dry clean <br>
...
<!-- <div class="container mx-auto" style="padding:30px;">
    <div class="">
      <div class="col-12">
        <h3 class="title11">Recommended Products</h3>
      </div>
    </div>
    <div class="row fpd" style=" padding-top: 30px;">
      <div class="mx-auto col-lg-3 col-md-12 col-sm-12 col-xs-12">
        <div class="products ">
        <a href="./MENTEE3.HTML"> <img src="./mbrown1.webp" alt="" class="mx-auto d-block" style="width: 250px; height: 300px;"></a>
      ...
      <div class="mx-auto col-lg-3 col-md-12 col-sm-12 col-xs-12">
        <div class="products">
            <a href="./MENTEE4.HTML"><img src="./MDENIUM.webp" class="mx-auto d-block" alt="" style="width: 250px; height: 300px;"></a>
          <h6>Regular Fit New Code Graphic Button Down Shirt</h6>
          <p>2000 RS</p>
        </div>
      </div>
      ...
      <div class="mx-auto col-lg-3 col-md-12 col-sm-12 col-xs-12">
        <div class="products">
            <a href="./MENTEE2.HTML"><img src="./MWHITE1.webp" class="mx-auto d-block" alt="" style="width: 250px; height: 300px; "></a>
          <h6>Regular Fit New Code Graphic Button Down Shirt</h6>
          <p>2000 RS</p>
        </div>
      </div>
 ...
 -->
  ...
  <footer class="site-footer">
    ...
    <script>
      ...
      var smallimg = documnet.getElementByClassName('small-img');
        function change1(){
            document.getElementById('MainImg').src = "{{\Illuminate\Support\Facades\Storage::url($products['img1'])}}";
        }
        function change2(){
            document.getElementById('MainImg').src = "{{\Illuminate\Support\Facades\Storage::url($products['img2'])}}";
        }
        function change3(){
            document.getElementById('MainImg').src = "{{\Illuminate\Support\Facades\Storage::url($products['img3'])}}";
        }
