...
<nav class="navbar navbar-light bg-light bg-white py-0"  id="nav">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-4 col-sm-4 col-xs-12"></div>
        <div class="col-md-4 col-sm-4 col-xs-12">
            <form action="adddetails" method="POST" class="form-container" name="Myform">
              @csrf  
                ...
                <div class="form-group">
                  ...
                  <small id="validEmail" class="form-text text-muted invalid-feedback">
                    <p style="color: red;">Email invalid, example: samanashraf@gmail.com</p>
                  </small>
                </div>
                <div class="form-group">
                  <label for="password">PASSWORD</label>
                  <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="password" onkeyup="Validate(this)">
                  <small id="validpwd" class="form-text text-muted invalid-feedback">
                    <p style="color: red;">password must contain 8-12 characters</p>
                  </small>
                </div>
                <button type="submit" id ="submit" class="btn btn-light btn-block">CREATE AN ACCOUNT</button>
              </form>
        </div>
    </div>
        <div class="col-md-4 col-sm-4 col-xs-12"></div>
...
submit.addEventListener('click', (e)=> {
  ...
  if(validfname && validlname && validemail && validpwd){
