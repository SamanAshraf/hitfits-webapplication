...
<head>
  <title>HitFits - Contact Us</title>
  <meta charset="utf-8">
    ...
    <div class="row details">
        <div class="container">
          <div class="col-md-12 col-sm-4 col-xs-12">
            <h4>HOW CAN I CONTACT HITFITS CUSTOMER SERVICE DEPARTMENT?</h4>
            <p style="margin-top: 30px;"><b>You can contact us with any questions related to online sales through the following channels:</b></p>
            <ul class="lists">
              <li>Through our Need Help service on the website</li>
              <li>UAN: 042-111-11 6387</li>
              <li>E-mail contactus@hitfits.com.pk</li>
              <li>Our social media pages on Facebook, Instagram </li>

            </ul>
            <p><b>Service Department Hours: Monday to Friday from 9.00 to 5.30 PST</b></p>
        </div>
        </div>
