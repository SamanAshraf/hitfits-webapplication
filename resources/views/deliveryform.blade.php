...
<head>
  <title>HitFits - Delivery Details</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-light bg-light bg-white py-0"  id="nav">
  ...
  <div id="success" class="alert alert-success alert-dismissible fade" role="alert">
    <strong>success!</strong> you have successfully entered your details. please proceed to checkout!
  ...
  <div id="failure" class="alert alert-danger alert-dismissible fade" role="alert">
    <strong>Error!</strong> Please fill out the form completely
    <button type="button" class="close" data-dismiss="alert" aria-label="close">
      <span aria-hidden="true"> &times;</span>
    </button>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h2 class="h1">Delivery Details</h2>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <form name="myForm"  action="addD" method="POST">
                  @csrf  
                  <input type="hidden" name="products_id"  value="{{ $details['productid'] }}">
                  @endforeach
        @endif
                    ...
                    <div class="form-group">
                      ...
                      <small id="validfname" class="form-text text-muted invalid-feedback">
                        <p style="color: red;">Your first name must be 2-30 characters long and should not start with a number</p>
                      </small>
                    </div>
                    <div class="form-group">
                      <label for="lname">Last Name  <span>*</span></label>
                      <input type="text" class="form-control" id="lname" placeholder="Enter Last Name" name="lastname">
                      <small id="validlname" class="form-text text-muted invalid-feedback">
                        <p style="color: red;">Your Last name must be 2-30 characters long and should not start with a number</p>
                      </small>
                    </div>
                    <div class="form-group">
                      <label for="address">Address  <span>*</span></label>
                      <input type="text" class="form-control" id="address" placeholder="Enter Address" name="address">
                      <small id="validaddress" class="form-text text-muted invalid-feedback">
                        <p style="color: red;">Enter your complete home Address</p>
                      </small>
                    </div>
                    <div class="form-group">
                      <label for="city">City <span>*</span></label>
                      <input type="text" class="form-control" id="city" placeholder="Enter City" name="city">
                      <small id="validcity" class="form-text text-muted invalid-feedback">
                        <p style="color: red;">please enter corrent city Name</p>
                      </small>
                    </div>
                    <div class="form-group">
                      <label for="city">Postal Code  <span>*</span></label>
                      <input type="text" class="form-control" id="code" placeholder="Enter Postal Code" name="postalcode">
                      <small id="validcode" class="form-text text-muted invalid-feedback">
                        <p style="color: red;">Postal code must be of 5 characters</p>
                      </small>
                    </div>
                    <div class="form-group">
                      <label for="num">Contact No  <span>*</span></label>
                      <input type="text" class="form-control" id="num" placeholder="Enter Contact No" name="contactno">
                      <small id="validnum" class="form-text text-muted invalid-feedback">
                        <p style="color: red;">Please Enter correct phone number! pattern: 923125076191, 00923125076191, +923125076191, 03125076191</p>
                      </small>
                    </div>
                    <div class="form-group">
                      <label for="descp">Additional Information</label>
                      <input style="height:110px;" type="text" class="form-control" id="desc" placeholder="....." name="details">
                    </div>
                    <button type="submit" class="btn btn-light btn-block" id="submit">Continue</button> 
                  </form>
...
const num = document.getElementById("num");
    ...
    address.addEventListener('blur', () => {
      ...
      let regex = /^[a-zA-Z0-9]([0-9a-zA-Z]){2,50}$/;
...
submit.addEventListener('click', (e)=> {
  ...
  if(validfname && validlname && validaddress && validcity && validlcode && validnum){
